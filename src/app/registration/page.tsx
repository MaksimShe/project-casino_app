      ...
      <div className="h-fill box-border flex w-[462px] flex-col items-center gap-8 rounded-[var(--main-radius)] bg-[#100F22] p-10 pt-4">
        <div className="flex w-full flex-col items-center justify-center">
          ...
          <form className="mt-10 flex w-full flex-col gap-2">
            ...
            <button
              type="submit"
              className="mt-8 h-12 w-full rounded-3xl bg-gradient-to-t from-[#FF0047] to-[#FF417B] font-bold text-white transition-shadow duration-300 hover:shadow-[0_0_18px_0_#FF5A8C]"
            >
              Sign Up
            </button>
          </form>
        ...
        <div className="flex w-full flex-col items-center justify-center gap-4">
          <p className="text-[#51A2FF] hover:text-[#AAD2FF]">

      ...
      <div className="flex flex-col items-center gap-6 text-center">
        ...
        {!isLoading && (
          <Link
            ...
            className="mt-4 rounded-3xl bg-gradient-to-t from-[#FF0047] to-[#FF417B] px-8 py-3 font-bold text-white transition-shadow duration-300 hover:shadow-[0_0_18px_0_#FF5A8C]"
          >
